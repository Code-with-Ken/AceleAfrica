...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-between min-h-screen p-24">
      <p className="text-3xl font-extrabold">This website is under construction</p>
      <AboutSection />
      {/* <div className="z-10 items-center justify-between w-full max-w-5xl font-mono text-sm bg-red-400 lg:flex">
